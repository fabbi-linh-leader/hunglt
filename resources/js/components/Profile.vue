                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-sm-12">
                                    <input type="email" dis v-model="form.email" class="form-control" id="inputEmail" placeholder="Email"  :class="{ 'is-invalid': form.errors.has('email') }">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group" >
                                 ...
                                 <div class="form-group" hidden="">
                                    <label for="inputEmail" class="col-sm-2 control-label">Type</label>
                                     <div class="form-group" >
                                        <select name="type" disabled="" v-model="form.type" id="type" class="form-control" :class="{ 'is-invalid': form.errors.has('type') }" >
